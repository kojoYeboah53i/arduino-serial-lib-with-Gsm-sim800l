...
//    Serial.println("ECG power restored at destination-B1");
    send_sms("destination-B1 System Turned On");
    spit_all();
    send_sms1("destination-B1 System Turned On");
    spit_all();
    send_sms2("destination-B1 System Turned On");
...
//    Serial.println("destination-B1 Control Box has been closed");
    send_sms("destination-B1 Control Box has been closed");
    spit_all();
    send_sms1("destination-B1 Control Box has been closed");
    spit_all();
    send_sms2("destination-B1 Control Box has been closed");
...
//    Serial.println("destination-B1 barrier turned on ");
    send_sms("destination-B1 barrier turned on ");
    spit_all();
    send_sms1("destination-B1 barrier turned on ");
    spit_all();
    send_sms2("destination-B1 barrier turned on ");
...
void loop() {
 ...
 if (sensorValue3 > 0) {
  ...
  if (sms_start && !sms_is_present ) {
    sms_start = false;
    delay(5000);
//    Serial.println("destination-B1 barrier turned off ");
    send_sms(" destination-B1 barrier turned off ");
    delay(5000);
    spit_all() ;
    send_sms1(" destination-B1 barrier turned off ");
    spit_all() ;
    delay(5000);
    send_sms2(" destination-B1 barrier turned off ");
...
//    Serial.println("Light off at Bechem Toll and running on UPS");
    send_sms("Light off at destination-B1 and running on UPS");
    delay(5000);
    spit_all() ;
    send_sms1("Light off at destination-B1 and running on UPS");
    delay(5000);
    spit_all() ;
    send_sms2("Light off at destination-B1 and running on UPS");
...
//    Serial.println("ECG power restored at destination-B1");
    send_sms("ECG power restored at destination-B1");
    delay(5000);
    spit_all();
    send_sms1("ECG power restored at destination-B1");
    delay(5000);
    spit_all();
    send_sms2("ECG power restored at destination-B1");
...
//    Serial.println("destination-B1 Control Box has been tempared with");
    send_sms("destination-B1 Control Box has been tempared with");
    delay(5000);
    // reboot();
    spit_all() ;

    send_sms1("destination-B1 Control Box has been tempared with");
    delay(5000);
    spit_all() ;
    send_sms2("destination-B1 Control Box has been tempared with");
